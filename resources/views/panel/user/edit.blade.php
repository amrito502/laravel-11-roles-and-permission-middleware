                ...
                <div class="card-body">
                    <form action="{{ route('user.update',$getRecord->id) }}" method="POST">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="name" value="{{ $getRecord->name }}" placeholder="name" id="name" class="form-control mt-2">
                        </div>

                        <div class="form-group mt-3">
                            <label for="email">Email</label>
                            <input type="text" value="{{ $getRecord->email }}" name="email" placeholder="email" id="email" class="form-control mt-2">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <span class="text-success">(Do you want to change password please add. otherwise leave)</span>
                        </div>
